...
import com.guyuai.framework.pay.core.client.impl.alipay.*;
import com.guyuai.framework.pay.core.client.impl.wx.WXLitePayClient;
import com.guyuai.framework.pay.core.client.impl.wx.WXNativePayClient;
import com.guyuai.framework.pay.core.client.impl.wx.WXPayClientConfig;
import com.guyuai.framework.pay.core.client.impl.wx.WXPubPayClient;
...
public class PayClientFactoryImpl implements PayClientFactory {
    ...
    private <Config extends PayClientConfig> AbstractPayClient<Config> createPayClient(
        ...
        // 创建客户端
        // TODO @老王 WX_LITE WX_APP 如果不添加在 项目启动的时候去初始化会报错无法启动。所以我手动加了两个，具体需要你来配
        switch (channelEnum) {
