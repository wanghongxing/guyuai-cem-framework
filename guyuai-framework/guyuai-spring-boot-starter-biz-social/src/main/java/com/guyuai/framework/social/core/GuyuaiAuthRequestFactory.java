package com.guyuai.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.guyuai.framework.social.core.enums.AuthExtendSource;
import com.guyuai.framework.social.core.request.AuthLionRequest;
import com.guyuai.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class GuyuaiAuthRequestFactory extends AuthRequestFactory {
    ...
    public GuyuaiAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
    ...
    protected AuthRequest getExtendRequest(String source) {
        ...
        switch (authExtendSource) {
            ...
            case LIONSSO:
                return new AuthLionRequest(config,authStateCache);
            default:
                return null;
        }
    }
