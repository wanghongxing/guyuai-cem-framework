 ...
 *      1）Spring Async：
 *          {@link com.guyuai.framework.quartz.config.GuyuaiAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 GuyuaiSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.guyuai.framework.tenant;
