package com.guyuai.framework.websocket.core;
...
public class GuyuaiWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public GuyuaiWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
