...
import com.guyuai.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import com.guyuai.module.infra.enums.codegen.CodegenColumnListConditionEnum;
import com.guyuai.module.infra.enums.codegen.CodegenTemplateTypeEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link com.guyuai.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getJavaField(), "name")) {
            column.setExample(randomEle(new String[]{"张三", "李四", "王五", "赵六", "老王"}));
            return;
        }
        // status
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.localhost");
            return;
        }
        // reason
