package com.guyuai.module.infra.service.codegen.inner;
...
import com.guyuai.framework.common.exception.util.ServiceExceptionUtil;
...
import com.guyuai.framework.common.util.date.LocalDateTimeUtils;
...
import com.guyuai.framework.excel.core.util.ExcelUtils;
import com.guyuai.framework.mybatis.core.dataobject.BaseDO;
...
import com.guyuai.framework.operatelog.core.enums.OperateTypeEnum;
...
import com.guyuai.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "guyuai-module-${table.moduleName}/" + // 顶级模块
                "guyuai-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "guyuai-module-${table.moduleName}/" + // 顶级模块
                "guyuai-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "guyuai-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "guyuai-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
