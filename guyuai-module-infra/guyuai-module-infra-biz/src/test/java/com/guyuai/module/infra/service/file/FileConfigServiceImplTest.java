package com.guyuai.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.guyuai.framework.common.pojo.PageResult;
import com.guyuai.framework.file.core.client.FileClient;
import com.guyuai.framework.file.core.client.FileClientConfig;
import com.guyuai.framework.file.core.client.FileClientFactory;
import com.guyuai.framework.file.core.client.local.LocalFileClient;
import com.guyuai.framework.file.core.client.local.LocalFileClientConfig;
import com.guyuai.framework.file.core.enums.FileStorageEnum;
import com.guyuai.framework.test.core.ut.BaseDbUnitTest;
import com.guyuai.module.infra.controller.admin.file.vo.config.FileConfigCreateReqVO;
import com.guyuai.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import com.guyuai.module.infra.dal.mysql.file.FileConfigMapper;
import com.guyuai.module.infra.mq.producer.file.FileConfigProducer;
import lombok.Data;
...
import static com.guyuai.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.guyuai.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.guyuai.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.guyuai.framework.test.core.util.AssertUtils.assertServiceException;
import static com.guyuai.framework.test.core.util.RandomUtils.randomLongId;
import static com.guyuai.framework.test.core.util.RandomUtils.randomPojo;
import static com.guyuai.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.guyuai.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai")
                .put("domain", "https://www.localhost").build();
        ...
        assertEquals("https://www.localhost", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // verify 调用
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://www.localhost")));
        ...
        FileConfigUpdateReqVO reqVO = randomPojo(FileConfigUpdateReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai2")
                    .put("domain", "https://doc.localhost").build();
            o.setConfig(config);
        });
        ...
        assertEquals("https://doc.localhost", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // verify 调用
        verify(fileConfigProducer).sendFileConfigRefreshMessage();
    }
    ...
    public void testGetFileConfigPage() {
       // mock 数据
       FileConfigDO dbFileConfig = randomFileConfigDO().setName("谷雨源码")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.localhost");

        // 调用，并断言
        assertEquals("https://www.localhost", fileConfigService.testFileConfig(id));
    }
