...
import com.guyuai.module.infra.controller.admin.job.vo.log.JobLogExportReqVO;
import com.guyuai.module.infra.controller.admin.job.vo.log.JobLogPageReqVO;
import com.guyuai.module.infra.dal.dataobject.job.JobLogDO;
import com.guyuai.module.infra.dal.mysql.job.JobLogMapper;
import com.guyuai.module.infra.enums.job.JobLogStatusEnum;
...
public class JobLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateJobLogResultAsync_success() {
        ...
        LocalDateTime endTime = RandomUtils.randomLocalDateTime();
