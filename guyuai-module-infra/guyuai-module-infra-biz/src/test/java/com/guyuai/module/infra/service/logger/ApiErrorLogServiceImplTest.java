package com.guyuai.module.infra.service.logger;
...
import com.guyuai.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.guyuai.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.guyuai.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.guyuai.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.guyuai.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.guyuai.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.guyuai.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("guyuai-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("guyuai-test");
