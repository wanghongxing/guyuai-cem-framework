package com.guyuai.module.member.service.auth;
...
import com.guyuai.module.member.controller.app.auth.vo.AppAuthResetPasswordReqVO;
import com.guyuai.module.member.controller.app.auth.vo.AppAuthUpdatePasswordReqVO;
import com.guyuai.module.member.dal.dataobject.user.MemberUserDO;
import com.guyuai.module.member.dal.mysql.user.MemberUserMapper;
import com.guyuai.module.member.service.user.MemberUserService;
import com.guyuai.module.system.api.logger.LoginLogApi;
import com.guyuai.module.system.api.oauth2.OAuth2TokenApi;
...
// TODO @老王：单测的 review，等逻辑都达成一致后
/**
 * {@link MemberAuthService} 的单元测试类
 *
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, GuyuaiRedisAutoConfiguration.class})
