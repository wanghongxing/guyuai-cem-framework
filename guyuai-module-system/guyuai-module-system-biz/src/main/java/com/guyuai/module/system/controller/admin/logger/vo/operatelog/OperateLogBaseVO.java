package com.guyuai.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @Schema(description = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从谷雨改成源码。")
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.guyuai.adminserver.UserController.save(...)")
