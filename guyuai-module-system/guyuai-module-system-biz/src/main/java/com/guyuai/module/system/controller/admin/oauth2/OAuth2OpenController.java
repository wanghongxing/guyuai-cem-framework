...
import com.guyuai.framework.common.util.http.HttpUtils;
import com.guyuai.framework.common.util.json.JsonUtils;
import com.guyuai.framework.operatelog.core.annotations.OperateLog;
...
import com.guyuai.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.guyuai.module.system.util.oauth2.OAuth2Utils;
...
import static com.guyuai.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.guyuai.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static com.guyuai.framework.common.pojo.CommonResult.success;
import static com.guyuai.framework.common.util.collection.CollectionUtils.convertList;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.localhost"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.localhost"),
