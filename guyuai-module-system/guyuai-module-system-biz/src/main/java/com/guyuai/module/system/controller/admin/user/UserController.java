package com.guyuai.module.system.controller.admin.user;
...
import static com.guyuai.framework.operatelog.core.enums.OperateTypeEnum.EXPORT;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@localhost").mobile("15601691300")
                        .nickname("谷雨").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("yuanma").deptId(2L).email("yuanma@localhost").mobile("15601701300")
