package com.guyuai.module.system.service.social;
...
import com.guyuai.framework.social.core.GuyuaiAuthRequestFactory;
import com.guyuai.module.system.api.social.dto.SocialUserBindReqDTO;
import com.guyuai.module.system.dal.dataobject.social.SocialUserBindDO;
...
import com.guyuai.module.system.dal.mysql.social.SocialUserMapper;
import com.guyuai.module.system.enums.social.SocialTypeEnum;
...
import static com.guyuai.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 GuyuaiAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private GuyuaiAuthRequestFactory guyuaiAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = guyuaiAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
    ...
    public SocialUserDO authSocialUser(Integer type, String code, String state) {
        ...
        log.debug("authUser: [{}]", JsonUtils.toJsonPrettyString( authUser));
        ...
        log.debug("socialUser: [{}]",JsonUtils.toJsonPrettyString( socialUser) );
...
//    @Override
//    public String getBindUserOnlineTicket(Integer userType, Integer type, Long userId) {
//
//
//        // 如果未绑定的社交用户，则无法自动登录，进行报错
//        SocialUserBindDO socialUserBind = socialUserBindMapper.selectByTypeAndUserId(userType,type,userId);
//        if (socialUserBind == null) {
//            throw exception(AUTH_THIRD_LOGIN_NOT_BIND);
//        }
//        return socialUserBind.getOnlineTicket();
//    }
