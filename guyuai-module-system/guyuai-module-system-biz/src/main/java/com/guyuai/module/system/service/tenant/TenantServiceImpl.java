...
import com.guyuai.framework.common.util.date.DateUtils;
...
import com.guyuai.framework.tenant.core.util.TenantUtils;
...
import com.guyuai.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 guyuai.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
