package com.guyuai.module.system.controller.admin.oauth2;
...
import com.guyuai.framework.common.util.collection.SetUtils;
import com.guyuai.framework.common.util.object.ObjectUtils;
import com.guyuai.framework.test.core.ut.BaseMockitoUnitTest;
import com.guyuai.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.guyuai.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.guyuai.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.guyuai.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.guyuai.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.guyuai.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.guyuai.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.guyuai.module.system.service.oauth2.OAuth2ApproveService;
import com.guyuai.module.system.service.oauth2.OAuth2ClientService;
import com.guyuai.module.system.service.oauth2.OAuth2GrantService;
import com.guyuai.module.system.service.oauth2.OAuth2TokenService;
...
import static com.guyuai.framework.common.util.collection.SetUtils.asSet;
...
import static com.guyuai.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://www.localhost";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.localhost#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.localhost#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read", result.getData());
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.localhost?code=test_code&state=test", result.getData());
    }
