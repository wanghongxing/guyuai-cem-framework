...
import com.guyuai.module.system.controller.admin.permission.vo.menu.MenuCreateReqVO;
import com.guyuai.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.guyuai.module.system.controller.admin.permission.vo.menu.MenuUpdateReqVO;
import com.guyuai.module.system.dal.dataobject.permission.MenuDO;
import com.guyuai.module.system.dal.mysql.permission.MenuMapper;
import com.guyuai.module.system.enums.permission.MenuTypeEnum;
import com.guyuai.module.system.mq.producer.permission.MenuProducer;
...
import static com.guyuai.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("老王").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
