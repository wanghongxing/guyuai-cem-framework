...
import com.guyuai.framework.test.core.ut.BaseDbAndRedisUnitTest;
...
import static com.guyuai.module.system.enums.ErrorCodeConstants.SOCIAL_USER_AUTH_FAILURE;
import static com.guyuai.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImplTest extends BaseDbAndRedisUnitTest {
    ...
    @MockBean
    private GuyuaiAuthRequestFactory authRequestFactory;
    ...
    public void testGetAuthorizeUrl() {
        try (MockedStatic<AuthStateUtils> authStateUtilsMock = mockStatic(AuthStateUtils.class)) {
            ...
            when(authRequest.authorize(eq("aoteman"))).thenReturn("https://www.localhost?redirect_uri=yyy");

            // 调用
            String url = socialUserService.getAuthorizeUrl(type, redirectUri);
            // 断言
            assertEquals("https://www.localhost?redirect_uri=sss", url);
        }
    }
