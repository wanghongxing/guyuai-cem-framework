package com.guyuai.module.system.service.tenant;

import com.guyuai.framework.common.enums.CommonStatusEnum;
import com.guyuai.framework.common.pojo.PageResult;
import com.guyuai.framework.tenant.config.TenantProperties;
import com.guyuai.framework.tenant.core.context.TenantContextHolder;
...
import com.guyuai.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import com.guyuai.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
...
import com.guyuai.module.system.dal.dataobject.permission.RoleDO;
...
import com.guyuai.module.system.dal.mysql.tenant.TenantMapper;
import com.guyuai.module.system.enums.permission.RoleCodeEnum;
import com.guyuai.module.system.enums.permission.RoleTypeEnum;
...
import com.guyuai.module.system.service.tenant.handler.TenantInfoHandler;
import com.guyuai.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.guyuai.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
...
import static com.guyuai.framework.test.core.util.RandomUtils.*;
import static com.guyuai.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static com.guyuai.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("谷雨", user.getNickname());
        ...
        TenantCreateReqVO reqVO = randomPojo(TenantCreateReqVO.class, o -> {
            ...
            o.setDomain("https://www.localhost");
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("谷雨"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("谷雨");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
