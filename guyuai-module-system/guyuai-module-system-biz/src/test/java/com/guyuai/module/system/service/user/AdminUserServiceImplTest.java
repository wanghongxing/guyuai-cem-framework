package com.guyuai.module.system.service.user;
...
import com.guyuai.framework.common.util.collection.ArrayUtils;
import com.guyuai.framework.common.util.collection.CollectionUtils;
import com.guyuai.framework.test.core.ut.BaseDbUnitTest;
import com.guyuai.module.infra.api.file.FileApi;
import com.guyuai.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.guyuai.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.guyuai.module.system.controller.admin.user.vo.user.*;
import com.guyuai.module.system.dal.dataobject.dept.DeptDO;
import com.guyuai.module.system.dal.dataobject.dept.PostDO;
import com.guyuai.module.system.dal.dataobject.dept.UserPostDO;
...
import com.guyuai.module.system.dal.mysql.dept.UserPostMapper;
import com.guyuai.module.system.dal.mysql.user.AdminUserMapper;
import com.guyuai.module.system.enums.common.SexEnum;
import com.guyuai.module.system.service.dept.DeptService;
import com.guyuai.module.system.service.dept.PostService;
import com.guyuai.module.system.service.permission.PermissionService;
import com.guyuai.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("guyuaiyuanma");
        ...
        assertEquals("guyuaiyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("guyuaiyuanma"))).thenReturn("java");
